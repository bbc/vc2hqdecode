/*****************************************************************************
 * invtransform_c.hpp : Inverse transform header: plain C++ version
 *****************************************************************************
...
VC2EXPORT InplaceTransformFinal get_invhtransformfinal_c(int wavelet_index, int active_bits, int sample_size);

#endif /* __INVTRANSFORM_C_HPP__ */
